...
export const apiEndpoints = {
  ...
  orderRevDiff: (
    key: string,
    fromRevNo: number | string,
    toRevNo: number | string,
  ...
  orderRevOpFieldRefs: (
    ...
    revNo: number | string,
    seqNo: number | string,
  ) => `orders/${key}/revs/${revNo}/ops/${seqNo}/field-refs`,
  orderRevOpFieldRef: (
    key: string,
    revNo: number | string,
    seqNo: number | string,
    refSeqNo: number | string,
  ) => `orders/${key}/revs/${revNo}/ops/${seqNo}/field-refs/${refSeqNo}`,
  orderRevOpFieldRefAvailable: (
    key: string,
    revNo: number | string,
    seqNo: number | string,
  ) => `orders/${key}/revs/${revNo}/ops/${seqNo}/field-refs/available`,
  orderRevOpDeps: (
    key: string,
    revNo: number | string,
    seqNo: number | string,
