...
describe("NAISYS Mail E2E", () => {
  ...
  test("should send mail from alex to bob and bob receives it", async () => {
    ...
    await naisys.waitForPrompt(7);

    // Send a new line to trigger mail notification
    naisys.sendNewLine();
    await naisys.waitForPrompt(8);
