...
export const apiEndpoints = {
  ...
  passwordRegister: "/auth/password/register",
  ...
  userClearPassword: (username: string) => `/users/${username}/password/clear`,
  ...
  agentRunLogEntries: (username: string) => `/agents/${username}/runLogEntries`,
  ...
  agentChatThreadRuns: (username: string, participants: string) =>
  ...
  agentSchedules: (username: string) => `/agents/${username}/schedules`,
  agentScheduleTrigger: (username: string, scheduleName: string) =>
    `/agents/${username}/schedules/${encodeURIComponent(scheduleName)}/trigger`,
  ...
  hostRotateAccessKey: (hostname: string) =>
    `/hosts/${hostname}/rotate-access-key`,
  ...
  variables: "/variables",
  codexOAuthStart: "/variables/codex-oauth/start",
  codexOAuthPoll: "/variables/codex-oauth/poll",
  codexOAuthUsage: "/variables/codex-oauth/usage",
