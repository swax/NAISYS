...
export const apiEndpoints = {
  ...
  variables: "/variables",
  openAiCodexOAuthStart: "/variables/openai-codex-oauth/start",
  openAiCodexOAuthPoll: "/variables/openai-codex-oauth/poll",
  openAiCodexOAuthUsage: "/variables/openai-codex-oauth/usage",
