...
export async function createDatabaseService() {
  ...
  async function openDatabase(filepath: NaisysPath): Promise<Database> {
    const hostPath = filepath.toHostPath();
  ...
  const createThreadMembersTable = `CREATE TABLE IF NOT EXISTS ThreadMembers (
    id INTEGER PRIMARY KEY, 
  ...
  const createThreadMessagesTable = `CREATE TABLE IF NOT EXISTS ThreadMessages (
    id INTEGER PRIMARY KEY, 
    threadId INTEGER NOT NULL, 
    userId INTEGER NOT NULL, 
  ...
  const createDreamLogTable = `CREATE TABLE IF NOT EXISTS DreamLog (
    id INTEGER PRIMARY KEY, 
    username TEXT NOT NULL,
    date TEXT NOT NULL,
    dream TEXT NOT NULL
  ...
  const createContextLogTable = `CREATE TABLE IF NOT EXISTS ContextLog (
    id INTEGER PRIMARY KEY, 
    username TEXT NOT NULL,
    role TEXT NOT NULL,
    source TEXT NOT NULL,
...
`;
  ...
  const createThreadMembersIndexes = `
